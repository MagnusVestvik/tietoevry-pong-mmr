...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateEmployee', function() {
      beforeEach(function() {
        instance = new TietoevryPongMmr.UpdateEmployee();
      });

      it('should create an instance of UpdateEmployee', function() {
        // TODO: update the code to test UpdateEmployee
        expect(instance).to.be.a(TietoevryPongMmr.UpdateEmployee);
      });
